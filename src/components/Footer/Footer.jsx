...
const Footer = () => {
  return (
    <footer className='bg-zinc-100 py-20'>
                ...
                <span className='text-orange-500 uppercase'>F</span>resh<span className='text-orange-500 uppercase'>K</span>art
                        </a>
                ...
                <ul className='flex-1'>
                    <li>
                        <h5 className='tezt-zinc-800 text-2xl font-bold'>Company</h5>
                    </li>
                    <li className='mt-6'>
                ...
                <ul className='flex-1'>
                    <li>
                        <h5 className='tezt-zinc-800 text-2xl font-bold'>Support</h5>
                    </li>
                    <li className='mt-6'>
                    ...
                    <div className='flex-1'>
                        <h5 className='tezt-zinc-800 text-2xl font-bold'> Stay Connected</h5>
