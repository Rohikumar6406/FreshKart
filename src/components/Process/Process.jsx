...
const steps =[
    {
        ...
        title: 'Sourcing',
        para: 'Sourcing the freshest, farm-picked goodness daily',
        icon: <PiPlant />
    },

    {
        ...
        title: 'Manufacturing',
        para: 'Manufacturing quality you can trust',
        icon: <PiFactoryBold />
    },

    {
        ...
        para: 'Where freshness meets strict quality control',
...

    {
        ...
        title: 'Logistics',
        para: 'Fast, reliable delivery at your doorstep',
        icon: <PiTruckDuotone />
    },
]
