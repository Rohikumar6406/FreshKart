...
import Fruits from "../../assets/Fruits and Veggies.jpg";
import Milk from "../../assets/Milk and Dairy.jpg";
import Fish from "../../assets/Meat and Fish.jpg";
  ...
  const renderCards = category.map((card) => {
    return (
      <div className="flex-1 basis-[300px]" key={card.id}>
        <div className="w-full h-56 mt-10 -mb-12 relative overflow-hidden">
          <img
            src={card.image}
  ...
  return (
    <section>
      <div className="max-w-[1400px] mx-auto px-10 py-20">
        ...
        {/* Category Card */}
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 md:mt-15 mt-10">
          {renderCards}
        </div>
      </div>
    </section>
